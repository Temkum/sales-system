                ...
                <div class="card-body">
                    <div class="customer-avatar-section">
                        <div class="d-flex align-items-center flex-column">
                            <img class="img-fluid rounded my-3" src="{{ asset('assets/img/avatars/user-avatar.png') }}"
                    ...
                    <div class="info-container">
                        <small class="d-block pt-4 border-top fw-normal text-uppercase text-muted my-3">{{ __('DETAILS')
                            }}</small>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="hover-actions-trigger position-static">
                                                <td class="measurement btn-reveal-trigger">
                                                    <a
                                                        href="{{ route('measurement-details', ['measurement_id' => $measurement->id]) }}">{{
                                                        $measurement->title ?? '#' . $measurement->id }}</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
