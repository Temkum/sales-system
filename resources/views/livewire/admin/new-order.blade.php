                        ...
                        <form>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-3">
                                            ...
                                            <input wire:model="item_qty.0" class="form-control" type="number"
                                                min="0" placeholder="{{ __('Qty') }}" name="item_qty"
                                                required>
                                            @error('item_qty')
                                                <span class="text-danger error">{{ $message }}</span>
                                            @enderror
                          ...
                          add-btn">{{ __('Add more') }}</span>
                                    ...
                                    @foreach ($items as $key => $value)
                                        <div class="row mt-3">
                                            <div class="col-lg-4 col-md-5">
                                                <input wire:model="item_name.{{ $value }}" class="form-control"
                                            ...
                                            <div class="col-lg-2 col-md-3">
                                                <input wire:model="item_qty.{{ $value }}" class="form-control"
                                                    type="number" min="0" placeholder="{{ __('Qty') }}"
                                                    required>
                                                @error('item_qty')
                                                    <span class="text-danger error">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-lg-4 col-md-5">
                                                <input wire:model="item_price.{{ $value }}" class="form-control"
                                                    type="number" placeholder="{{ __('Enter item price') }}" required>
                                                @error('item_price')
                                                    <span class="text-danger error">{{ $message }}</span>
                                                @enderror
                                            </div>
                        ...
                        <form wire:submit.prevent="addSale()">
                            ...
                            <div class="mb-3 row">
                                <label for="html5-text-input"
                                    class="col-md-2 col-form-label">{{ __("Client's name") }}</label>
                                <div class="col-md-10">
                            ...
                            <div class="mb-3 row">
                                <label for="html5-text-input"
                                    class="col-md-2 col-form-label">{{ __('Address') }}</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="address" placeholder="Sandpit, Buea"
                            ...
                            <div class="mb-3 row">
                                <label for="html5-tel-input"
                                    class="col-md-2 col-form-label">{{ __('Phone') }}</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="telephone" placeholder="675 827 455"
                            ...
                            <div class="mb-3 row">
                                <label for="html5-number-input"
                                    class="col-md-2 col-form-label">{{ __('Price') }}</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="number" aria-disabled="disabled"
                                        ...
                                        value="{{ $this->items_in_cart->sum('item_price') }}" disabled>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="html5-number-input"
                                    class="col-md-2 col-form-label">{{ __('Advance Paid') }}</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="number" placeholder="0.00"
                                        wire:model="advance" maxlength="15" min="0">
                                    @error('advance')
                                        <span class="text-danger error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3 row">
                                <label for="html5-datetime-local-input"
                                    class="col-md-2 col-form-label">{{ __('Due Date') }}</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="datetime-local"
                                        placeholder="2023-06-18T12:30:00" id="html5-datetime-local-input"
                                        wire:model="due_date">
                                    @error('due_date')
                                        <span class="text-danger error">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="center-item">
                                <button type="submit"
                                    class="btn btn-dark btn-md w-50 text-uppercase">{{ __('Add Sale') }}
                                </button>
                            </div>
                        </form>
                    @endif
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3" style="position: relative;">
                        ...
                        <div class="d-flex flex-column align-items-center gap-1">
                            ...
                            @elseif((int) $advance > $this->items_in_cart->sum('item_price'))
                                <small
                                    class="mb-2 badge bg-secondary">{{ number_format((int) $advance - $this->items_in_cart->sum('item_price'), 2) }}
                                </small>
                            ...
                            @else
                                <h4 class="mb-2">
                                    {{ number_format($this->items_in_cart->sum('item_price') - (int) $advance, 2) }}
                                </h4>
                            ...
                            <div class="col-md-6">
                                <div class="user-progress d-flex align-items-center gap-1">
                                    @if ($this->items_in_cart)
                                        <h2 class="mb-0">
                                            {{ number_format($this->items_in_cart->sum('item_price'), 2) }}</h2>
                                    @endif
                                    <span class="text-muted">XAF</span>
                                </div>
                                <span>Total</span>
