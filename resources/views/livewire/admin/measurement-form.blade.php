        ...
        <form wire:submit.prevent="save">
          ...
          <tr>
            <td>
              <div class="input-group input-group-sm">
                ...
                <input type="number" class="form-control form-control-sm" aria-label="Epaule" wire:model="epaule" />
              </div>
              @error('epaule')
            ...
            <td>
              <div class="input-group input-group-sm">
                ...
                <input type="number" class="form-control form-control-sm" aria-label="Taille" wire:model="taille_b" />
              </div>
              @error('taille_b')
                <span class="text-danger error">{{ __('This field is required') }}</span>
              @enderror
          ...
          <tr>
            ...
            <td>
              <div class="input-group input-group-sm">
                ...
                <input type="number" class="form-control form-control-sm" aria-label="Bassin" wire:model="bassin_b" />
              </div>
              @error('bassin_b')
                <span class="text-danger error">{{ __('This field is required') }}</span>
              @enderror
          ...
          <tr>
            <td>
              <div class="input-group input-group-sm">
                ...
                <input type="number" class="form-control form-control-sm" aria-label="Poitrin" wire:model="poitrine" />
              </div>
              @error('poitrine')
                <span class="text-danger error">{{ __('This field is required') }}</span>
              @enderror
          ...
          <tr>
            <td>
              <div class="input-group input-group-sm">
                <span class="input-group-text sm">{{ __('Taille') }}</span>
                <input type="number" class="form-control form-control-sm" aria-label="Taille" wire:model="taille_t" />
              </div>
              @error('taille_t')
                <span class="text-danger error">{{ __('This field is required') }}</span>
              @enderror
            ...
            <td>
              <div class="input-group input-group-sm">
                ...
                <input type="number" class="form-control form-control-sm" aria-label="Cuisses" wire:model="cuisses" />
              </div>
              @error('cuisses')
                <span class="text-danger error">{{ __('This field is required') }}</span>
              @enderror
          ...
          <tr>
            <td>
              <div class="input-group input-group-sm">
                ...
                <input type="number" class="form-control form-control-sm" aria-label="L. Total" wire:model="l_total" />
              </div>
              @error('l_total')
                <span class="text-danger error">{{ __('This field is required') }}</span>
              @enderror
            ...
            <td>
              <div class="input-group input-group-sm">
                ...
                <input type="number" class="form-control form-control-sm" aria-label="Fond" wire:model="fond" />
              </div>
              @error('fond')
                <span class="text-danger error">{{ __('This field is required') }}</span>
              @enderror
          ...
          <tr>
            <td>
              <div class="input-group input-group-sm">
                <span class="input-group-text sm">{{ __('Bassin') }}</span>
                <input type="number" class="form-control form-control-sm" aria-label="Bassin" wire:model="bassin_t" />
              </div>
              @error('bassin_t')
                <span class="text-danger error">{{ __('This field is required') }}</span>
              @enderror
          ...
          <tr>
            ...
            <td>
              <div class="input-group input-group-sm">
                ...
                <input type="number" class="form-control form-control-sm" aria-label="Pied" wire:model="pied" />
              </div>
              @error('pied')
                <span class="text-danger error">{{ __('This field is required') }}</span>
              @enderror
