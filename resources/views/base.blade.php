                ...
                <form action="" method="GET">
                  ...
                  <ul class="menu-inner py-1">
                    ...
                    <li class="menu-header small text-uppercase"><span
                        class="menu-header-text">{{ __('Misc') }}</span>
                    </li>
                    <li class="menu-item">
                      <a href="#" target="_blank" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-support"></i>
                    ...
                    <input type="text" class="form-control border-0 shadow-none" placeholder="Search..."
                      wire:model="search" aria-label="Search..." name="search" id="search" />
                        ...
                        <ul class="menu-inner py-1">
                          ...
                          <li
                            class="menu-item {{ request()->route()->named('product-categories') ? 'active' : '' }}">
                            <a href="{{ route('product-categories') }}" class="menu-link">
                              <i class="menu-icon tf-icons bx bx-category"></i>
                              <div>{{ __('Products') }}</div>
                            </a>
                                        ...
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                          <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                              <h6 class="mb-1">
                                                {{ $notification->data['client_name'] ?? 'No client' }}</h6>
                                  ...
                                  <li>
                                    <a class="dropdown-item" href="#">
                                      <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                          <div class="avatar avatar-online">
                                            <img src="{{ asset('assets/img/avatars/user-avatar.png') }}"
