...
<<<<<<< HEAD
      ...
      <div class="layout-page">
        ...
        <nav
          ...
          <<<<<<< HEAD <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            <!-- Search -->
                    ...
                    <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-3">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end py-0">
                        ...
                        {{-- <li class="dropdown-menu-footer border-top p-3">
                          <button class="btn btn-primary text-uppercase w-100 view-all-notifications">{{ __('view all
  ...
  <<<<<<< HEAD {{-- @if (!request()->route()->named('add-order') && !request()->route()->named('register') &&
    !request()->route()->named('login') && !request()->route()->named('password.request') &&
    !request()->route()->named('password.reset') && !request()->route()->named('order-details') &&
    !request()->route()->named('add-user') && !request()->route()->named('add-record'))
    ...
    =======
    {{-- @if (!request()->route()->named('add-order') && !request()->route()->named('register') &&
    !request()->route()->named('login') && !request()->route()->named('password.request') &&
    !request()->route()->named('password.reset') && !request()->route()->named('order-details') &&
    !request()->route()->named('add-user') && !request()->route()->named('add-record'))
    <div class="buy-now" id="new_order">
