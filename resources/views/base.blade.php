        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Components -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Authentication</span>
                    </li>
                    <!-- Cards -->
                    <li class="menu-item">
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div
                            ...
                            <div class="mb-2 mb-md-0"> Pacho Design
                                ...
                                made with ❤️ by
                                <a href="https://www.kumjudetem.com" target="_blank"
                                    class="footer-link fw-bolder">Kum Jude</a>
                            </div>
                            <div>
