...
@section('content')
  ...
  <div class="row">
    <div class="col-md-5 col-lg-4 mb-4">
      <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title m-0 me-2">{{ __('Details') }}</h5>
        </div>
        <div class="card-body">
    ...
    <div class="col-md-7 col-lg-7">
      <div class="card mb-4">
        <h5 class="card-header">{{ __('Modify') }}</h5>
        <!-- Account -->
        <div class="card-body">
          <div class="d-flex align-items-start align-items-sm-center gap-4">
            ...
            <div class="button-wrapper">
              ...
              <p class="text-muted mb-0">{{ __('Allowed JPG, GIF or PNG. Max size of 800KB') }}</p>
            </div>
          </div>
        </div>
        <hr class="my-0" />
        <div class="card-body">
          <form id="formAccountSettings" method="POST" action="{{ route('user-profile-information.update') }}"
